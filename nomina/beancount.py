...
class Beancount:
    ...
    def create_transaction(self, date: date, description: str, postings: List[Tuple[str, float, str]],
        ...
        tx= data.Transaction(meta, date, '*', payee, description, data.EMPTY_SET, data.EMPTY_SET, txn_postings)
        return tx

    def entries_to_string(self, preamble: Preamble, entries: Optional[List[data.Directive]] = None) -> str:
        """
